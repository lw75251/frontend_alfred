            ...
            Positioned(
              ...
              child: Align(
                ...
                child: DefaultTextStyle(
                  ...
                  child: Text("Scan the code on the table"),
                ),
              ),
            ),
            Positioned(
...
class QrScanBoxPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(QrScanBoxPainter oldDelegate) => true;

  @override
  bool shouldRebuildSemantics(QrScanBoxPainter oldDelegate) => true;
}
